...
export function StepLease({
  ...
  const form = useForm<StepLeaseValues>({
    // Removed 'as any' for better type safety, assuming Zod schema is correct
          ...
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Agreement Amount <span className="text-red-500">*</span></FormLabel>
                    <FormControl>
                        <Input
                          type="number"
                          {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Template ID <span className="text-red-500">*</span></FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
                    <FormDescription>
                      Internal reference for the lease document.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field: { value, onChange, ...fieldProps } }) => (
                  <FormItem className="md:col-span-1 lg:col-span-2">
                    ...
                    <FormLabel>
                      Representative Document (If leasing by Rep.)
                    </FormLabel>
                    <FormControl>
                      <Input
                        type="file"
              ...
              <div className="md:col-span-2 lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 border-t">
                ...
                <FormField
                  control={form.control}
                  name="witness_3_full_name"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Witness 3 Full Name</FormLabel>
                      <FormControl>
                        <Input placeholder="Full Name" {...field} value={field.value ?? ""} />
                      </FormControl>
                      <FormMessage />
