...
import { StepRepresentativeSchema } from "../schemas";
import type { StepRepresentativeValues } from "../types";
...
export function StepRepresentative({
  ...
  const form = useForm<StepRepresentativeValues>({
    ...
    defaultValues: {
      ...
      email: "",
      role: "representative",
      id_file: null, // Should be null or undefined depending on schema
    },
  });
